...
create unique index user_phone_inx on users(user_phone_number);
...
create table categories_blog (
    categories_blog_id int generated by default as identity primary key,
    category_id int not null references categories(category_id),
...
`insert into question_type(type) values (1, 2, 3)`
...
-- // POST: addCommentAboutCourse("/users/course/comment")        +
-- // GET: To Get info of user("/")                               +


--  22.09.2021
 
-- // GET: teacherPage("/teacher-page/:id")                       +
-- // GET: itemCourse("/course/:id"),                 // headersda user_id jo'natish kerak, optional    ?
-- // POST: addBlog("/teacher/blog"),
-- // GET: allBlogs("/blogs"),                                    +
-- // DELETE: deleteBlog("/teacher/blog/id"),

--  24.09.2021
-- // GET: blogItem("/blog/:id"),                                 +
-- // GET: allTeachers("/teachers"),                              +
-- // DELETE: comment about course("/admin/course/comment/IdComment"),

-- 29.09.2021
-- // PUT: Publish Course("/teacher/course/publish/id"),

-- 06.10.2021
-- // POST: Add quiz ("/teacher/quiz"),
-- // DELETE: Delete quiz ("/teacher/quiz/id"),
